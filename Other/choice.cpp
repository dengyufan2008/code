...
vector<T> flower = {
    ...
    T(0, "h", 4778.6, "Cp", 13.2, "Cd", 6.2, "a", 17.5, "A", 8.7),
    T(1, "h", 4778.6, "Cd", 20.2, "Cp", 9.3, "H", 4.7),
    T()};
vector<T> feather = {
    T(0, "a", 310.8, "Cp", 9.7, "Cd", 7.8, "H", 21.0),
    T(0, "a", 310.8, "Cp", 10.9, "Cd", 7.8, "A", 9.3, "m", 33),
    T(0, "a", 310.8, "Cp", 2.7, "Cd", 11.7, "m", 79, "h", 508),
    T(0, "a", 310.8, "Cp", 7.0, "Cd", 18.7, "m", 56, "A", 4.7),
    T(0, "a", 310.8, "Cp", 6.6, "Cd", 21.0, "m", 56, "H", 5.8),
    T(0, "a", 310.8, "Cp", 7.4, "Cd", 13.2, "H", 11.1, "h", 568),
    T(0, "a", 310.8, "Cp", 11.7, "Cd", 10.9, "H", 9.3, "m", 23),
    T(1, "a", 310.8, "Cp", 11.7, "Cd", 14.8, "h", 299),
...
vector<T> head = {
    ...
    T(0, "Cp", 31.1, "Cd", 21.0, "A", 9.3, "h", 209, "a", 35),
